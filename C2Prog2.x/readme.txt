...
First release of a complete rewrite with multiplatform support.
Add JSON-RCP server.
IMPORTANT:  This version does not contain the entirety of the 1.9 functionlity. 
            See user manual for details.

~~~
1.9.0 (1/29/22)
Add support for 28003x devices.
Update PCAN drivers.
Update EmuPack to version 9.2.0.

~~~
1.8.11 (5/8/21)
Migration to MSVC 2017 binaries.
Bug fixes and stability improvements.

~~~
1.8.10 (10/22/20)
Add support for 28002x devices.

~~~
1.8.9 (10/17/20)
Fix crash introduced in 1.8.7 which occurs on systems that are missing ftd2xx.dll. 
Allow configuring alternate boot modes for 28x7x devices.
Add UTF support.
...
~~~
1.8.7 (6/28/20)
Add support for FTDI SPI adapter.

~~~
1.8.6 (1/12/20)
Add support for 2838x devices.

~~~
1.8.5 (12/14/19)
Support unlocking of dual zone security.
Add INTOSC support for 2837x, 2807x and 28004x devices.
Support both flash banks on single-core 2837x devices.
Make naming of target configurations more uniform.
Add C2Prog Command Prompt shortcut and c2p-gdb utility.

~~~
1.8.4 (9/8/19)
Add Gdb non-intrusive attach.
Bug fixes and stability improvements.

~~~
1.8.3 (6/19/19)
Add C2000 EABI (ELF) support.

~~~
1.8.2 (6/9/19)
Add support for XDS2xx emulators.

~~~
1.8.1 (6/1/19)
Support *.out files (COFF/ELF).
Include TI emulation package 7.0.188.0 as installation option.
Major refactoring of GUI.
New EHX format.

~~~
1.7v (4/13/19)
Add further checks to OTP programming (28004x, 2807x, 2837x).
...
~~~
1.7t (1/20/19)
Update CAN loader for 280049.
Properly catch 1.8 EHX format.

~~~
1.7s (10/27/18)
Update 28004x support.
Allow programming of both 280049 banks.
Add emulator scripting.
Add XDS110 2-pin cJTAG selection ("xds110-2w").
Support new ehx container.

~~~
1.7r (3/4/18)
Update TI emu pack to v7.0.188.0.
Provide XDS110 support.

~~~
1.7q (12/10/17)
Add automatic reconnect when TCP/IP socket is lost.
Add support for NI-XNET CAN adapters.
Add 28004x support.
Update TI emu pack to v6.0.628.1.
