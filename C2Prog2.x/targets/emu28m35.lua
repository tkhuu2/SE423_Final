...
--	print("Emulator reset.")
	...
	readLong(h, 0x680800) -- dummy read to OTPSEC	
	...
	-- unlock CSMZ2
	readLong(h, 0x27FFF0) -- dummy reads
	readLong(h, 0x27FFF4)
	readLong(h, 0x27FFF8)
	readLong(h, 0x27FFFC)
	...
	-- unlock ECSLZ2
	readLong(h, 0x27FFE8) -- dummy reads
	readLong(h, 0x27FFEC) -- dummy reads
	writeLong(h, 0x400FB428, 0xFFFFFFFF) -- write passwords
	writeLong(h, 0x400FB42C, 0xFFFFFFFF)
		
	-- grab sectors	
	readLong(h, 0x27FFDC) -- read flash EXEZ2
	readLong(h, 0x27FFE4) -- Z2 GRABSECT
	readLong(h, 0x27FFE0) -- Z2 GRABRAM	
